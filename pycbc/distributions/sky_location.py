...
class HealpixSky:
    ...
    def rvs(self, size):
        # First of all, apply the coverage criterion the skymap. Then, 
        # draw a random sample of pixel indices following the given 
        # probabilities. This is the trivial part of the algorithm.
